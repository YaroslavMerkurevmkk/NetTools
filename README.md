...
Попробовать работу от администратора можно воспользовавшись admin:1234 при авторизации
Тамже для корректной работы программы ее следует запускать от суперпользователя и нужна утилита ifconfig
